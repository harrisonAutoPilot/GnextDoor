...
type Props = {};
class Profile_Activity_Jobs extends React.Component <Props> {
     ...
     const ratingObj = {
      ...
      return (
        ...
        <View style={styles.MainContainer}>
                     ...
                     <TouchableOpacity  onPress={() => this.props.navigation.navigate('Profile_Activity')}  activeOpacity = { .5 } style={styles.backArrow}>
                     <View>
                      ...
                      <Image source={require('../../assets/sun.jpeg')} style={{width:wp('100%'), height:150,resizeMode:'cover'}}  />
                       <View style={{flexDirection:'column',marginTop:-60}}>
                                 ...
                                 <View style={{height:hp('1%'),flexDirection:'row', width:wp('55%'),left:wp('29%')}}>
                                                     <View style={{ width:140,justifyContent:'center', alignItems:'center', zIndex:4}}>
                                                      ...
                                                      <View style={{ width:wp('8%'),justifyContent:'center', flexDirection:'row', marginTop:-14}}>
                     ...
                     <View style={{flexDirection:'column', alignItems:'center'}}>
                       <Text style={{fontSize:15, paddingLeft:10,paddingRight:10,color:'#5a0c5a',fontWeight:'bold'}}>19</Text>
                       <Text style={{fontSize:
                        10,paddingLeft:10,paddingRight:10,color:'#EBB81D',fontWeight:'bold' }}>REQUEST</Text>
                     </View>

                     <View style={{flexDirection:'column', alignItems:'center'}}>
                       <Text style={{fontSize:15, paddingLeft:10,paddingRight:10,color:'#5a0c5a',fontWeight:'bold'}}>19</Text>
                       <Text style={{fontSize:
                        10,paddingLeft:10,paddingRight:10,color:'#EBB81D',fontWeight:'bold' }}>PENDING</Text>
                     </View>

                     <View style={{flexDirection:'column', alignItems:'center'}}>
                       <Text style={{fontSize:15, paddingLeft:10,paddingRight:10,color:'#5a0c5a',fontWeight:'bold'}}>19</Text>
                       <Text style={{fontSize:
                        10,paddingLeft:10,paddingRight:10,color:'#EBB81D',fontWeight:'bold' }}>COMPLETED</Text>
                     </View>
...
export default Profile_Activity_Jobs;
