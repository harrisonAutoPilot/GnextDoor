...
class Profile_Activity_Short extends React.Component <Props> {
                       ...
                       <View style={{flexDirection:'column',marginTop:-60}}>
                                 ...
                                 <View style={{height:hp('1%'),flexDirection:'row', width:wp('55%'),left:wp('29%')}}>
                                                     <View style={{ width:140,justifyContent:'center', alignItems:'center', zIndex:4}}>
                                                          <Text style={{fontSize:18,fontWeight:'bold', alignItems:'center', justifyContent:'center', fontFamily:'Roboto', color:'#fff'}}>Top Class Food Vendors</Text>
                                                     </View>
                                                      ...
                                                      <View style={{ width:wp('50%'),justifyContent:'center', alignItems:'center', marginLeft:wp('28%'),marginTop:25}}>
                                                           <Text style={{fontSize:11, alignItems:'center', justifyContent:'center',color:'#fff',fontFamily:'Roboto', }}>Specialty in african and Western Cuisine</Text>
                                                      </View>
                        </View>
...
export default Profile_Activity_Short;
