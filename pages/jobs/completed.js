...
import {comData} from '../../util/job/completedJobData';
           ...
           <View style={styles.listContent}>
              ...
              <Text style={styles.secondRowText}>{val.transCode}</Text></View>
                        ...
                        <View style={styles.btn}>
                          ...
                          <Image style={styles.userImageContainer} source={require('../../assets/calendar.png')} style={{width:15, height:15, marginRight:30}} />
                        </View>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                 <Text style={styles.locTextMessage1}>{val.swipe}</Text>
                  <View style={{flexDirection:'row',marginRight:7}}><Text style={styles.locTextMessage1}> Status:<Text style={{color:'#009900',}}> {val.status}</Text></Text></View>
                </View>
