...
import {pendingData} from '../../util/job/pendingJobData';
...
class Pending extends React.Component <Props> {
 ...
 {
  pendingData && pendingData.length > 0 && pendingData.map(val => {
   return (
    <TouchableOpacity  onPress = {() => {
     ...
     <View style={styles.listContainer} key={val.id}>
         ...
         <Image source={val.img} style={{height:70, width:70,alignItems:'center', borderRadius:50, }}/>
           ...
           <View style={styles.listContent}>
              ...
              <View style={{flexDirection:'row',width:196,justifyContent:'flex-start', marginLeft:35,}}>
              <Text style={styles.secondRowText}>{val.transCode}</Text></View>

                        <View style={styles.btn}>
                          <Image style={styles.userImageContainer} source={require('../../assets/calendar.png')} style={{width:15, height:15, marginRight:7}} />
                        </View>
                        <View style={styles.btn1}>
                           <Text style={styles.locTextMessage2}>{val.date} Left</Text>
                        </View>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                 <Text style={styles.locTextMessage1}>{val.swipe}</Text>
                  ...
                  <TouchableOpacity style={styles.compleBtn} onPress = {() => this.RBSheet.open()}>
                  <Text style={{fontSize:7, color:'gray'}}>COMPLETE</Text>
                  </TouchableOpacity>
                  </View>
                </View>
      ...
      <Modal
         ...
         onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
             ...
             <Image source={require('../../assets/smile.png')} style={styles.smileImg} />
                     ...
                     <View style={{alignItems:'center', flexDirection:'column'}}>
                          <Text style={{fontSize:35 , color:'#009900',margin:3,textAlign:'center'}}>Congratulations!!!</Text>
                          <Text style={{fontSize:13, fontWeight:'bold',color:'#666666',margin:3, textAlign:'center'}}> Fund will be Released Within 12 - 24 hours.</Text>
       ...
       <Modal
          ...
          onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
              ...
              <View><Text style={styles.Te}> Pending Job</Text></View>
              </View>
          ...
          <View style={styles.btnContainer}>
              <View style={styles.requestService}>
              <TouchableOpacity style={styles.reqBtn} onPress = {() => this.RBSheet.open()}>
              <Text style={{color:'#fff', fontSize:13,}}>COMPLETE REQUEST</Text>
              </TouchableOpacity>
              </View>
              <View style={styles.otherServiceBtn}>
              <TouchableOpacity style={styles.bckBtn}  onPress = {() => {
                  this.props.navigation.navigate('Profile_Activity_Short')}}>
              <Text style={{color:'#fff', fontSize:9.5,}}>TERMINATE REQUEST</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.bckBtn} onPress = {() => {
                          this.setState({ isVisibleRequest:!this.state.isVisibleRequest})}}>
              <Text style={{color:'#fff', fontSize:9.5,}}>GO BACK</Text>
              </TouchableOpacity>
              </View>
     ...
     >
                  ...
                  <View style={styles.selectMessage}><Text style={{fontSize:16,color:'gray',fontWeight:'bold', marginTop:30}}>Are you sure You have completed the Job?</Text></View>
                  </View>
