...
import {jobData} from '../../util/job/newJobData';
   ...
   return (
    <TouchableOpacity  onPress = {() => {
         ...
         <Image source={val.img} style={{height:70, width:70,alignItems:'center', borderRadius:50, }}/>
          ...
          <Text style={styles.secondRowText}>{val.transCode}</Text></View>
                        ...
                        <View style={styles.btn}>
                          <Image style={styles.userImageContainer} source={require('../../assets/calendar.png')} style={{width:15, height:15, marginLeft:10}} />
                        </View>
         ...
         onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
             ...
             <Image source={require('../../assets/smile.png')} style={styles.smileImg} />
                     ...
                     <View style={{alignItems:'center', flexDirection:'column'}}>
                          <Text style={{fontSize:35 , color:'#009900',margin:3}}>Congratulations!!!</Text>
                          <Text style={{fontSize:13, fontWeight:'bold',color:'#666666',margin:3}}>Kindly ensure that you Deliver / Complete</Text>
                          <Text style={{fontSize:18, fontWeight:'bold', color:'#666666',margin:3}}>On or Before: 20/05/2020</Text>
                     </View>
          ...
          onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
              ...
              <View><Text style={styles.Te}>Job Request</Text></View>
                ...
                <View style={styles.btnContainerReq}>
                    ...
                    <TouchableOpacity style={styles.bckBtn} onPress = {() => {
                         this.setState({ isVisibleService:!this.state.isVisibleService})}}>
                    <Image source={require('../../assets/technology.png')} style={{width:40, height:30}} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.bckBtn} onPress = {() => this.RBSheet.open()}>
                    <Image source={require('../../assets/symbol.png')} style={{width:20, height:20}} />
                    </TouchableOpacity>
                    </View>
                    </View>
          </View>
     ...
     >
                  ...
                  <View style={styles.selectMessage}><Text style={{fontSize:16,color:'gray',fontWeight:'bold', marginTop:30}}>Are you sure You want to Decline Request</Text></View>
                  </View>
