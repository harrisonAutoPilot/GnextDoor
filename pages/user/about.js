          ...
          showsVerticalScrollIndicator={false}>
           ...
           <View>
               <View style={styles.cardsDown}>
                ...
                <Text style={{fontSize:16,fontWeight:'bold',color:'#009900', marginLeft:19, marginTop:12, marginBottom:12,fontFamily:'Roboto', }}>Previous Jobs</Text>
               {
              jobs && jobs.length > 0 && jobs.map(val => {
                return (
               <View style={styles.galleryDown}>
               <View style={styles.gallery} key={val.id}>
                     <Image source={val.img} style={{height:150, width:395,marginRight:1, borderRadius:10 }}/>
                     <View style={styles.galleryFooter}>
                        <View style={styles.jobInfo}>
                         <Text style={{fontSize:18, color:'gray', width:300, marginTop:5,fontFamily:'Roboto', }}>{val.name}</Text>
                     ...
                     <View style={{flexDirection:'row', width:370, justifyContent:'flex-start', alignItems:'center'}}>
                          <Text style={{fontSize:14, color:'#EBB81D', width:150, marginBottom:5,fontFamily:'Roboto', }}>{val.buyer}</Text>
                          <Image source={require('../../assets/locc.png')} style={{height:12, width:12, marginRight:2,marginBottom:5}}/>
                           <Text style={{fontSize:13, color:'#ebb81d',marginBottom:5,fontFamily:'Roboto', }}>{val.location}</Text>
                     </View>
               ...
               <View style={styles.certificate}>
                   <Image source={require('../../assets/certificate.png')} style={{height:150, width:100,resizeMode:'contain'}}/>
              <View style={{flexDirection:'row',width:width, height:30, alignItems:'center', justifyContent:'center'}}>
                  <Text style={{fontSize:17, color:'#009900',alignSelf:'center', width:140, fontWeight:'bold',fontFamily:'Roboto', }}>Gnexdor verified!</Text>
