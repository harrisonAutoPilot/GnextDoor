            ...
            return (
                ...
                <View style={styles.review}>
                           <View style={styles.name}>
                               <View style={styles.user_name}><Text style={{fontWeight:'bold',  fontSize:15,fontFamily:'Roboto', }}>{val.name}</Text></View>
                            ...
                            <View style={styles.title}>
                                <View style={styles.review_title}><Text style={{ fontWeight:'bold',fontFamily:'Roboto', }}>{val.title}</Text></View>
                            </View>
