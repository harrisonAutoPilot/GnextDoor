               ...
               <View style={styles.gallery} key={val.id}>
                     ...
                     <View style={styles.galleryFooter}>
                        <View style={styles.jobInfo}>
                         <Text style={{fontSize:18, color:'gray', width:320,marginTop:5}}>{val.name}</Text>
                           <Image source={require('../../assets/share.png')} style={{height:20, width:20, marginRight:10}}/>
                          <Image source={require('../../assets/trash.png')} style={{height:20, width:20, }}/>
                        </View>

                     </View>

                     <View style={{flexDirection:'row', width:370, justifyContent:'flex-start', alignItems:'center',}}>
                          <Text style={{fontSize:15, color:'#EBB81D', width:150, marginBottom:5}}>{val.buyer}</Text>
                          <Image source={require('../../assets/locc.png')} style={{height:12, width:12, marginRight:5, marginBottom:5}}/>
                           <Text style={{fontSize:13, color:'#EBB81D', marginBottom:5}}>{val.location}</Text>
                     </View>
