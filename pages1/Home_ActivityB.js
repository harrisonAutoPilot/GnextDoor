...
class Home_ActivityB extends Component{
 ...
 render(){
  ...
  return(
       ...
       <View style={{position:'absolute',width:wp('80%'), height:hp('12%'),top:hp('2%'), justifyContent:'center', alignItems:'center', zIndex:9, right:wp('40%'),}}>
       <PulseAnim  />
          ...
          <Image source={require('../images/left.png')} style={{height:16, width:16,marginLeft:5  }} />
             ...
             <View>
              <TouchableOpacity
               ...
               <Text style={{color:'#000000', fontSize:10}}>Location</Text>
               </TouchableOpacity>
              </View>
              ...
              <View>
               <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Select')}
                style = {styles.searchButtonTop}>
               <Text style={{color:'#000000', fontSize:10}}>Most Searched</Text>
                </TouchableOpacity>
               </View>
               <View>
                <TouchableOpacity
                 onPress={() => this.props.navigation.navigate('Select')}
                 style = {styles.searchButtonTop}>
               <Text style={{color:'#000000', fontSize:10}}>Mobile Business</Text>
                 </TouchableOpacity>
                </View>
                <View>
                 <TouchableOpacity
                  onPress={() => this.props.navigation.navigate('Select')}
                  style = {styles.searchButtonTop}>
                <Text style={{color:'#000000', fontSize:10}}>Static Business</Text>
                  </TouchableOpacity>
                 </View>
             </ScrollView>
